...
const names=['Grim Tutor','Gut Shot','Haunted Ridge','Hexing Squelcher','Hideous End','Jet Medallion','Kardur, Doomscourge',"Kaya's Ghostform"];
test('Valgavoth integration batch 3 is reachable in the real runtime database',()=>{
