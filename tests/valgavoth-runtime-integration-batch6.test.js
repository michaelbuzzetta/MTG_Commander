...
const names=['Roiling Vortex','Ruby Medallion','Scrawling Crawler','Shadowspear','Shivan Gorge','Smash to Smithereens','Smoke','Solphim, Mayhem Dominus'];
test('Valgavoth integration batch 6 is reachable in the real runtime database',()=>{
