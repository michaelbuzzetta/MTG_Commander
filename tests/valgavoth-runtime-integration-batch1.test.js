...
const names=['Backlash','Bedevil','Blazemire Verge','Blood Seeker','Bloodchief Ascension','Chandra, Awakened Inferno','Crypt Ghast','Dark Ritual'];
test('Valgavoth integration batch 1 is reachable in the real runtime database',()=>{
