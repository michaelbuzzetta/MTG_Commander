...
const names=['Deadly Rollick','Deflecting Swat','Delirium','Exquisite Blood','Forsaken Wastes',"Geth's Verdict",'Gleeful Arsonist','Graven Cairns'];
test('Valgavoth integration batch 2 is reachable in the real runtime database',()=>{
